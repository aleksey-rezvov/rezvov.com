    ...
    <section id="expertise" className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-zinc-900/50">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-12">
          ...
          <div className="bg-zinc-800/50 p-4 sm:p-6 rounded-lg border border-zinc-700">
            <h3 className="text-lg sm:text-xl font-semibold text-blue-400 mb-2 sm:mb-3">FSM-Based AI Systems</h3>
            <p className="text-sm sm:text-base text-zinc-300">
              Experience architecting finite state machine-based AI systems for predictable behavior, 
              enabling testability and compliance in production environments.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 sm:mt-12">
          ...
          <div className="mt-8 sm:mt-12">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 text-sm sm:text-base">
              ...
              <div className="bg-zinc-800/50 p-4 rounded-lg border border-zinc-700">
                <div className="font-semibold text-blue-400 mb-2">Compliance</div>
                <div className="text-zinc-300">GDPR, HIPAA, SOC 2, ISO 27001</div>
              </div>
            </div>
          </div>
        </div>
